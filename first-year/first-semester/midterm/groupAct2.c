...
int main()
{
    ...
    if(opt == '2')
    {
        ...
        printf("                P = ?                                                                  \n");
        printf("            Answer :                                                                   \n");
        printf("                P = %g therefore, the City population would be about              \n", ans);
        printf("                                %g after %g years.                             \n", ans, t);
        printf("=======================================================================================\n");
    }
    ...
    if(opt == '3')
    {
        ...
        printf("                r = ?                                                                  \n");
        printf("            Answer :                                                                   \n");
        printf("                r = %g therefore, the City population would be about              \n", ans);
        printf("                                %g after %g years.                             \n", ans, t);
        printf("=======================================================================================\n");
    }
    ...
    if(opt == '4')
    {
        ...
        printf("                t = ?                                                                  \n");
        printf("            Answer :                                                                   \n");
        printf("                t = %g therefore, the City population would be about              \n", ans);
        printf("                                %g after %g years.                             \n", ans, t);
        printf("=======================================================================================\n\n");
    }
